...
The lineages through time plot (Statistics-&gt;Lineages-through-time plot) function
produces a graph showing how the number of extant lineages depends on the age above
the most recent leaf in the tree.

The Skyline plot (see [Pybus et al., 2000](http://www.genetics.org/content/155/3/1429)
